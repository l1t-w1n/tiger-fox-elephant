...
class Config:
    DATA_DIR = project_root / "data/diffusion/fox_new"
    WEIGHTS_DIR = project_root / "weights/diffusion/diffusion.v3.1_fox"
    LOG_DIR = project_root / "logs/diffusion.v3.1_fox"
    output_dir = project_root / "diffusion_samples/diffusion.v3.1_fox"
